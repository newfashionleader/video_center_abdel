 ...
 */
final class Version20241105111541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE video ADD user_id INT NOT NULL, ADD relation VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE video DROP user_id, DROP relation');
    }
}
